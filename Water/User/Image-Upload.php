...
$sql_record = "SELECT * FROM water_image_upload WHERE user_id='" . $uid . "' AND month = '$due_month'";
$recordsDetails = mysqli_query($link, $sql_record);



$records_img = mysqli_query($link, "SELECT * FROM water_image_upload WHERE user_id = '$uid'");
$data_img = mysqli_fetch_assoc($records_img);

$sql_details = "SELECT * FROM water_details WHERE user_id='" . $uid . "'";
        ...
        <div class="row gutters-sm">
                            ...
                            <table class="table table-striped table-hover" style="font-size: 14px;" id="newTable">
                                <thead style="font-weight: bold;font-size: 16px;">
                                    <tr>
                                        <th>Month</th>
                                        <th>Meter Image</th>
                                        <th style="text-align: center;">Download Image</th>
                                ...
                                ?>
                                    <tr>
                                        <td style="text-align: center;">
                                            ...
                                            $sql_img = "SELECT * FROM water_image_upload WHERE month='" . $img_month . "'";
                                            $records_img_month = mysqli_query($link, $sql_img);
                                            $data_img_month = mysqli_fetch_assoc($records_img_month);

                                            $arrear_rem_one = "SELECT * FROM water_pay WHERE user_id = '$uid' AND id = (SELECT MAX(id)-$i FROM water_pay)";
                                        ...
                                        <td style="text-align: center;"><i class="fa fa-file-image-o" aria-hidden="true"></i>&nbsp;<?php echo $data_img_month['filename']; ?></td>
                                        <td style="text-align: center;"><a href="Download.php?user_id=<?php echo urlencode($data_img_month['user_id']); ?>&month=<?php echo urlencode($img_month); ?>"><?php $data_img_month['filename']; ?><i class="fa fa-download"></i></a></td>

                                        <td style="text-align: center;">
                                            <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#photo<?php echo $id; ?>">View</button>
                                                        ...
                                                        <div class="px-3 needs-validation">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="form-group col-md-10 p-2">
                                                                    <h5 style="text-align: center;">National Water Supply and Drainage
                                                                        Board<br>Statement of Water Account<h5>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-4">
                                                                    <label>Arrears for <?php echo $data_img['month'] ?></label>
                                        ...
                                        <td style="text-align: center;"><a href="Pdf.php?user_id=<?php echo $uid; ?>&month=<?php echo $data_img_month['month'];; ?>"><i class="fa fa-download" aria-hidden="true"></i></a></td>
            ...
            ?>
                <div class="col-md-6"><br>
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                ...
                                <table class="table">
                                    ...
                                    $sql_one = "SELECT * FROM water_image_upload WHERE user_id = '$uid' AND month = '$due_month'";
                    ...
                    <?php
                    $sql_prev_bill = "SELECT * FROM water_bill WHERE user_id='" . $uid . "' AND month = '$due_month'";
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if ($filename == null) {
                            ...
                            if ($ext == "png" || $ext == "PNG" || $ext == "JPG" || $ext == "jpg" || $ext == "jpeg" || $ext == "JPEG") {
                                $sql = "INSERT INTO water_image_upload (user_id, month, filename, image, filetype, size) VALUES ('$user_id', '$month','$filename','$content', '$file_type','$file_size')";
