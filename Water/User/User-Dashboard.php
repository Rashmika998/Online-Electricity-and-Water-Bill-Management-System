...
$sql_img = "SELECT * FROM water_image_upload WHERE user_id='" . $uid . "' AND month = '$due_month'";
    ...
    <div class="col-lg-12 p-4 pt-12" style="background-color: #E5E4E2;">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="align-items-center text-center">
                                                <p style="font-size: 18px;">Welcome to Water Bill Management System with NWSDB</p style="font-size: 18px;">
                                            </div>
                                            <img src="../../images/water.png" class="d-block w-100" alt="...">

                                        </div>
                                        <div class="carousel-item">
                                            <div class="align-items-center text-center">
                                                <h4>First Step</h4>
                                                <p>Register for Water Bill Management System by Providing Relevant
                                                    Information.</p>
                                            </div>
                    ...
                    <div class=" col-md-6">
                        <div class="card border shadow-lg mb-3 p-2">
                            <div class="card-body align-items-center text-center">
                                ...
                                <a href="../../Current/User/User-Dashboard.php"><button class="btn btn-danger">Switch to
                                        Electricity Bill&nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i></button></a>
                        ...
                        <div class="col-md-14">
                            <div class="card border shadow-lg mb-3 p-2">
                                ...
                                <?php
                                $sql = "SELECT * FROM water_details WHERE user_id='" . $uid . "'";
                                ...
                                ?>
                                    ...
                                    <div class="card-body align-items-center text-center btn btn-light">
                                        <div class="row">
                                            <h5 class="align-items-center text-center">Your are not Registered yet. Please register if you are willing.
                                                <?php echo $status; ?>...</h5>
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-striped  bg-warning progress-bar-animated" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
                                                </div>
                        ...
                        <div class="col-md-14">
                            <div class="card border shadow-lg mb-2 p-2">
                                <div class="card-body align-items-center text-center">
                                    ...
                                    <?php
                                    } else if ($data_method['category'] == 'Industry 1') {
                                    ?>
        ...
        <div class="row gutters-sm">
            <div class=" col-md-6 mb-3">
                <div class="card border shadow-lg p-2">
                    <h2 class="align-items-center text-center">Water Usage</h2>
                    <?php
                    $sql_units = "SELECT * FROM water_bill WHERE user_id='" . $uid . "' LIMIT 2";
