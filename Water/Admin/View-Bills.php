...
function allUsers()
{
    ...
    $all = mysqli_query($db, "SELECT * FROM water_bill");
    ...
    <div class="col-lg-8 bg-white p-4">
        ...
        <div class="table-responsive-sm">
            <table class="table table-striped table-hover" style="font-size: 14px;" id="myTable">
                ...
                $records_bill = mysqli_query($db, "SELECT * FROM water_bill WHERE month = '$bill_month'");
                ...
                ?>
                    <tr>
                        <td style="text-align: center;">
                            ...
                            $recordDetails = mysqli_query($db, "SELECT * FROM water_details WHERE user_id = '$uid'");
                        ...
                        <td>
                            <?php
                            $records_img = mysqli_query($db, "SELECT * FROM water_image_upload WHERE user_id = '$uid' AND month = '$bill_month'");
                        ...
                        <td style="text-align: center;"><a href="Download-Month.php?user_id=<?php echo urlencode($data_img['user_id']); ?>&month=<?php echo urlencode($bill_month) ?>"><?php $data_img['filename']; ?><i class="fa fa-download"></i></a></td>

                        <td style="text-align: center;">
                            <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#<?php echo $data['user_name']; ?>">View&nbsp;<i class="fa fa-file-text-o" aria-hidden="true"></i></button>


                        </td>
                        <div class="modal fade" id="<?php echo $data['user_name']; ?>" tabindex="-1" aria-labelledby="<?php echo $data['user_name']; ?>Label" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header bg-primary">
                                        <h4 class="modal-title" id="<?php echo $data['user_name']; ?>Label" style="color: white;">
                                            Bill</h4>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="px-3 needs-validation">
                                            <div class="row">
                                                <div class="col-md-2"><img src="../../images/water_bill.png"></div>
                        ...
                        <td style="text-align: center;"><a href="Pdf.php?user_id=<?php echo $uid; ?>&month=<?php echo $bill_month; ?>"><i class="fa fa-download" aria-hidden="true"></i></a></td>
                        <td style="text-align: center;">
                            <?php
                            ...
                            <?php
                                ...
                                $records_pay = mysqli_query($db, "SELECT * FROM water_pay WHERE user_id = '$uid'");
                                $data_pay = mysqli_fetch_assoc($records_pay);
                            ?>
                                <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#<?php echo $data_pay['token']; ?>">Paid&nbsp;<i class="fa fa-list-alt" aria-hidden="true"></i></button>

                                <div class="modal fade" id="<?php echo $data_pay['token']; ?>" tabindex="-1" aria-labelledby="<?php echo $data_pay['token']; ?>Label" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header bg-success">
                                                <h4 class="modal-title" id="<?php echo $data_pay['token']; ?>Label" style="color: white;">
                                                    Payment</h4>
                                            ...
                                            <div class="modal-body">
                                                <div class="px-3 needs-validation" style="text-align: left;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="<?php echo $bill_month; ?>" disabled>
                                                    </div><br>

                                                    <div class="form-group">
                                                        <label>Name</label>
                                                        <input type="text" class="form-control" value="<?php echo $data_pay['pay_name'] ?>" disabled>
                                                    </div><br>

                                                    <div class="form-group">
                                                        <label>NIC Number</label>
                                                        <input type="text" class="form-control" value="<?php echo $data_pay['pay_nic'] ?>" disabled>
                                                    </div><br>

                                                    <div class="form-group">
                                                        <label>Amount(Rs.)</label>
                                                        <input type="text" class="form-control" value="<?php echo $data_pay['pay_amount'] ?>" disabled>
                                                    </div><br>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
