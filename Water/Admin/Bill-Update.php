...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO water_bill (user_id, month, meter, units, charge, total, due) VALUES ('$user_id', '$month', '$meter', '$units', '$charge', '$total', '$due')";
    $update = "UPDATE water_image_upload SET status = 'Prepared' WHERE user_id = '$user_id'";
