...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO water_notifications (user_id, month, message) VALUES ('$user_id', '$month', '$message')";
    ...
    if (mysqli_query($link, $sql)){
        try {
            ...
            $mail->Subject = 'Online Electricity and Water Bill Management System Reminder for Image Upload';
