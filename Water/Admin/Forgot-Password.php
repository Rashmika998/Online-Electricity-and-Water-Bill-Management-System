...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($data=mysqli_fetch_array($records)){
        ...
        try {
            ...
            $mail->Subject = "Online Current and Water Bill Management System -Administrator Recover Password";

            $mail->Body    = "Dear $admin_name , <br><br> Click the below link to reset the password<br>
            <a href='http://localhost/OCAWBMS/Water/Admin/Reset-Password.php?admin_id=$admin_id'>
           <h4> Reset Password</h4></a>
            ...
            you may want to change your password as someone may have guessed it.<br>  <br> Best Regards <br> OEAWBMS Team";
