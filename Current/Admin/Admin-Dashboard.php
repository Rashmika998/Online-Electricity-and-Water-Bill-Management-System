...
function pendingUsers()
{
    ...
    $pending = mysqli_query($db, "SELECT * FROM current_details WHERE status = 'Pending'");
...
{
    $db = new mysqli('localhost', 'root', '', 'ocawbms');
    $approved = mysqli_query($db, "SELECT * FROM current_details WHERE status = 'Approved'");
...
{
    $db = new mysqli('localhost', 'root', '', 'ocawbms');
    $rejected = mysqli_query($db, "SELECT * FROM current_details WHERE status = 'Rejected'");
...
function imageUploaded()
{
    ...
    $image_uploaded = mysqli_query($db, "SELECT * FROM image_upload WHERE status = 'Pending' AND month = '$bill_month'");
...
function pendingPay()
{
    ...
    $data_month = mysqli_fetch_assoc($records_month);
    $bill_month = $data_month['month'];
    $pending_pay = mysqli_query($db, "SELECT * FROM current_bill WHERE status = 'Not Paid' AND month = '$bill_month'");
...
function totalPay()
{
    ...
    $data_month = mysqli_fetch_assoc($records_month);
    $bill_month = $data_month['month'];
    $total_pay = mysqli_query($db, "SELECT * FROM current_bill WHERE status = 'Paid' AND month = '$bill_month'");
        ...
        <div class="row gutters-sm">
            <div class=" col-md-4 mb-3">
                <div class="border card p-2">
                    <h2 class="align-items-center text-center">Customer Electricity Usage for Month</h2>
                    <div class="card-body">
                        <?php
                        ...
                        $domestic = mysqli_query($link, "SELECT * FROM current_bill WHERE month = '$bill_month'");
                        while ($result_domestic = mysqli_fetch_array($domestic)) {
                            $unit_uid = $result_domestic['user_id'];
                            $units = mysqli_query($link, "SELECT * FROM current_details WHERE user_id = '$unit_uid'");
                    ...
                    <div class="card border  mb-3 p-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                $sql_admin = "SELECT * FROM admin WHERE admin_id = '$admin_id' AND type = 'Electricity'";
                                ...
                                <div class="row gutters-sm">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input disabled type="text" class="form-control" value="<?php echo $data_admin['admin_username'] ?>">
                                    </div>
                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body paid">
                                                                <table class="table table-striped table-hover table-paid" style="font-size: 14px;" id="paidTable">
                                                                    ...
                                                                    <?php
                                                                    $records = mysqli_query($link, "SELECT * FROM current_bill WHERE status = 'Paid' AND month = '$month'");
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <table class="table table-striped table-hover" style="font-size: 14px;" id="pendingTable">
                                                                    ...
                                                                    <?php
                                                                    $records = mysqli_query($link, "SELECT * FROM current_bill WHERE status = 'Not Paid' AND month = '$month'");
                            ...
                            <div class="col-md-3">
                                <div class="card mb-3 alert-primary fade show">
                                    <div class="panel-heading ">
                                        <div class="stat-panel text-center">
                                            <div class="stat-panel-number h1 ">
                                                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#imageUpload">
                                                    <div class="row">
                                                        <div class="col-md-3" style="float:left;
                                                        border-radius: 100%;color:blue"><i class="fa fa-upload fa-2x" aria-hidden="true"></i>
                                                        </div>
                                                        <div class="col-md-8">
                                                            <h4 class="stat-panel-title">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-primary">
                                                                <h4 class="modal-title" id="imageUploadLabel" style="color: white;">
                                                            ...
                                                            <div class="modal-body">
                                                                <table class="table table-striped table-hover" style="font-size: 14px;" id="imgTable">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Username</th>
                                                                        </tr>
                                                                    ...
                                                                    $records = mysqli_query($link, "SELECT * FROM image_upload WHERE status = 'Pending' AND month = '$month'");
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <a style="text-decoration: none; float: right;color:primary;" href="View-Registration.php?user_id=<?php echo $data['user_id'] ?>">Update
                                                                                    Bill
                                    ...
                                    <div class="panel-heading">
                                        <div class="stat-panel text-center">
                                            <div class="stat-panel-number h1">
                                                ...
                                                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#notUpload">
                                                    <div class="row">
                                                        <div class="col-md-3" style="float:left;
                                                        border-radius: 100%;color:#DE5D83"><i class="fa fa-picture-o fa-2x" aria-hidden="true"></i>
                                                        </div>
                                                        <div class="col-md-8">
                                                            <h4 class="stat-panel-title">
                                                ...
                                                <div class="modal fade" id="notUpload" tabindex="-1" aria-labelledby="notUploadLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header" style="background-color: #DE5D83;">
                                                                <h4 class="modal-title" id="notUploadLabel" style="color: white;">
                                                                    Users Pending to Upload Image</h4>
                                                                <button type="button" class="btn" style="background-color: #DE5D83; color: white;" data-bs-dismiss="modal" aria-label="Close">
                                                                    <i class="fa fa-times" aria-hidden="true"></i>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <table class="table table-striped table-hover" style="font-size: 14px;" id="pendingImgTable">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Username</th>
                                                                        </tr>
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <a style="text-decoration: none; float: right;color:#DE5D83;" href="View-Registration.php?user_id=<?php echo $data_not['user_id'] ?>">Reminder
                                ...
                                <div class="col-md-4">
                                    <div class="card mb-4 p-1 alert-warning fade show">
                                        <div class="panel-heading">
                                            <div class="stat-panel text-center">
                                                <div class="stat-panel-number h1 ">
                                                    <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#pendingModal">
                                                        <div class="row">
                                                            <div class="col-md-6" style="float:left;
                                                        border-radius: 100%;color:#FF8C00"><i class="fa fa-user-plus fa-3x" aria-hidden="true"></i></div>
                                                            <div class="col-md-6">
                                                                <h4 class="stat-panel-title">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header bg-warning">
                                                                    <h4 class="modal-title" id="pendingModalLabel" style="color: white;">
                                                                        Pending Users</h4>
                                                                ...
                                                                <div class="modal-body">
                                                                    <table class="table table-striped table-hover" style="font-size: 14px;" id="pendingRegiTable">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>Username</th>
                                                                            </tr>
                                                                        ...
                                                                        <?php
                                                                        $records = mysqli_query($link, "SELECT * FROM current_details WHERE status = 'Pending'");
                                                                        ...
                                                                        ?>
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <a style="text-decoration: none; float: right;color:#FF8C00;" href="View-Registration.php?user_id=<?php echo $data['user_id'] ?>">View
                                                                                        Form
                                        ...
                                        <div class="panel-heading">
                                            <div class="stat-panel text-center">
                                                <div class="stat-panel-number h1 ">
                                                    ...
                                                    <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#approvedModal">
                                                        <div class="row">
                                                            <div class="col-md-6" style="float:left;
                                                        border-radius: 100%;color:green"><i class="fa fa-user fa-3x" aria-hidden="true"></i></div>
                                                            <div class="col-md-6">
                                                                <h4 class="stat-panel-title">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header bg-success">
                                                                    <h4 class="modal-title" id="approvedModalLabel" style="color: white;">
                                                                        Approved Users</h4>
                                                                    <button type="button" class="btn btn-success" data-bs-dismiss="modal" aria-label="Close">
                                                                        <i class="fa fa-times" aria-hidden="true"></i></button>
                                                                </div>
                                                                <div class="modal-body approved">
                                                                    <table class="table table-striped table-hover table-approved" style="font-size: 14px;" id="approvedTable">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>Username</th>
                                                                            </tr>
                                                                        ...
                                                                        <?php
                                                                        $records = mysqli_query($link, "SELECT * FROM current_details WHERE status = 'Approved'");
                                                                        ...
                                                                        ?>
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <a style="text-decoration: none; float: right;color:forestgreen" href="View-Registration.php?user_id=<?php echo $data['user_id'] ?>">View
                                                                                        Form
                                                                                        <i class="fa fa-file-text" aria-hidden="true"></i>
                                                                                    </a>
                                        ...
                                        <div class="panel-heading">
                                            <div class="stat-panel text-center">
                                                <div class="stat-panel-number h1 ">
                                                    ...
                                                    <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#rejectedModal">
                                                        <div class="row">
                                                            <div class="col-md-6" style="float:left;
                                                        border-radius: 100%;color:red"><i class="fa fa-user-times fa-3x" aria-hidden="true"></i></div>
                                                            <div class="col-md-6">
                                                                <h4 class="stat-panel-title">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header bg-danger">
                                                                    <h4 class="modal-title " id="rejectedModalLabel" style="color: white;">
                                                                        Rejected Users</h4>
                                                                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal" aria-label="Close">
                                                                        <i class="fa fa-times" aria-hidden="true"></i></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <table class="table table-striped table-hover" style="font-size: 14px;" id="rejectedTable">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>Username</th>
                                                                            </tr>
                                                                        ...
                                                                        <?php
                                                                        $records = mysqli_query($link, "SELECT * FROM current_details WHERE status = 'Rejected'");
                                                                        ...
                                                                        ?>
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <a style="text-decoration: none; float: right;color:red;" href="View-Registration.php?user_id=<?php echo $data['user_id'] ?>">View
                                                                                        Form
                                                                                        <i class="fa fa-file-text" aria-hidden="true"></i>
                                                                                    </a>
