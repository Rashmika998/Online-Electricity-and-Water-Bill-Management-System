...
$month = $_GET['month'];
$uname = $_GET['uname'];
$ad_res =  mysqli_query($link, "SELECT * FROM admin WHERE admin_username = '$uname'");
$ad_data = mysqli_fetch_assoc($ad_res);
...
$pdf->Cell(40, 8, date("Y/m/d"), 0, 1, 'L');
$pdf->Cell(40, 8, 'Issuing Officer', 0, 0, 'L');
$pdf->Cell(40, 8, $ad_data['admin_fullname'], 0, 1, 'L');
$pdf->SetY(260);
