...
<div class="row justify-content-center wrapper">
    <div class="col-lg-12 p-4 pt-12" style="background-color: #E5E4E2;">
        <div class="row gutters-sm">
            ...
            <div class="col-md-7">
                <div class="card border shadow-lg mb-4 p-2">
                    <h2 class="text-center">Registered Electricity Bill Management Form</h2>
                    <hr>
                ...
                <div class="card  border shadow-lg mb-3">
                    ...
                    <div class="card-body">
                        <div class="col-md-14">
                            ...
                            $sql_one = "SELECT * FROM image_upload WHERE user_id = '$uid' AND month = '$bill_month'";
                            $result_one = mysqli_query($link, $sql_one);
                            if($row = mysqli_fetch_array($result_one)){
                            ?>
                                <td><i class="fa fa-file-image-o"
                                        aria-hidden="true"></i>&nbsp;<?php echo $row['filename'];?></td>
                                <td style="text-align: center;"><a
                                        href="Download-Month.php?user_id=<?php echo urlencode($row['user_id']); ?>&month=<?php echo urlencode($bill_month) ?>"><?php $row['filename'];?><i
                            ...
                            <div class="form-row">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-10 p-2">
                                                                <h5 style="text-align: center;">Ceylon Electricity
                                                                    Board<br>Statement of Electricity Account<h5>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Name</label>
                                ...
                                <div class="form-group col-md-6">
                                    <button class="btn btn-danger btn-lg btn-block myBtn" data-bs-toggle="modal"
                                        data-bs-target="#rejectImageModal">Reject</button>

                                    <!-- Modal -->
                                    <div class="modal fade" id="rejectImageModal" tabindex="-1"
                                        aria-labelledby="rejectImageModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    Are you sure you want to Reject this image? If so please provide
                                                    Reasons
                                                    for Rejection.
                                                    <form class="px-3 needs-validation" method="POST"
                                                        action="Image-Rejected.php?user_id=<?php echo $data['user_id']?>">
                                                        <div class="form-group"><br>
                                                            <label>Reasons for Rejection</label>
                                                            <input type="text" class="form-control" name="feedback"
                                                                required placeholder="Please provide Reasons">
                                                        </div>
                ...
                <div class="card border shadow-lg mb-3">
                    ...
                    <div class="card-body">
                        <div class="col-md-14">
                            ...
                            $sql_img_one = "SELECT * FROM image_upload WHERE user_id = '$uid' AND month = '$bill_month'";
                            $result_img_one = mysqli_query($link, $sql_img_one);
                            if($row_img = mysqli_fetch_array($result_img_one)){
                            ?>
                                <td><i class="fa fa-file-image-o"
                                        aria-hidden="true"></i>&nbsp;<?php echo $row_img['filename'];?></td>
                                <td style="text-align: center;"><a
                                        href="Download-Month.php?user_id=<?php echo urlencode($row_img['user_id']); ?>&month=<?php echo urlencode($bill_month) ?>"><?php $row_img['filename'];?><i
                                            class="fa fa-download"></i></a></td>
                                <?php
                            }
                            ?>
                            ...
                            <div class="alert alert-success alert-dismissible fade show" role="alert"
                                style="text-align: center;">
                                Bill Created for <strong><?php echo $bill_month ?></strong>&nbsp;<i class="fa fa-check"
                                    aria-hidden="true"></i>
                            </div>
            ...
            <div class="col-md-5">
                <div class="card border shadow-lg mb-3">
                    ...
                    <div class="px-3 needs-validation">
                        <?php
                        $month_bill = "SELECT * FROM current_bill WHERE user_id='" . $uid . "' AND month = '$bill_month'";
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-10 p-2">
                                <br>
                                <h4 style="text-align: center;">Ceylon Electricity
                                    Board Statement of Electricity Account<h4>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                        ...
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" class="form-control" value="<?php echo $dataDetails['user_address'] ?>"
                                disabled>
                        </div>
                        <div class="form-group">
                            <label>Bill-Month</label>
                            <input type="text" class="form-control" value="<?php echo $results_month_bill['month'] ?>"
                                disabled>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                <label>Category</label>
                                <input type="text" class="form-control" value="<?php echo $dataDetails['category'] ?>"
                                    disabled>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Meter Reading</label>
                                <input type="text" class="form-control"
                                    value="<?php echo $results_month_bill['meter'] ?>" disabled>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                <label>Units Consumed for Month
                                    <?php echo date('F')?></label>
                                <input type="text" class="form-control"
                                    value="<?php echo $results_month_bill['units'] ?>" disabled>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Charge For the Month(Rs.)</label>
                                <input type="text" class="form-control"
                                    value="<?php echo $results_month_bill['charge'] ?>" disabled>
                            </div>

                            <div class="form-group col-md-6">
                                <label>Total Amount Due (Rs.)</label>
                                <input type="text" class="form-control"
                                    value="<?php echo $results_month_bill['total'] ?>" disabled>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Updated</label>
                                <input type="text" class="form-control"
                                    value="<?php echo $results_month_bill['updated_at']?>" disabled>

                            </div>

                            <div class="form-group col-md-6">
                                <label>Due Date</label>
                                <input type="date" class="form-control" value="<?php echo $results_month_bill['due'] ?>"
                                    disabled>
                            </div>
                        </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="table-responsive-sm">
                            <table class="table table-striped table-hover" style="font-size: 14px;" id="payTable">
                                ...
                                <?php
                    $records_one_bill = mysqli_query($link,"SELECT * FROM current_bill WHERE user_id = '$uid'");

                    while($data_bill_month=mysqli_fetch_assoc($records_one_bill)){
                        $results_month_bill = $data_bill_month['month'];

                        $results_month_image = mysqli_query($link,"SELECT * FROM image_upload WHERE month = '$results_month_bill' AND user_id = '$uid'");
                        $data_image_month=mysqli_fetch_assoc($results_month_image);
                        
                        $records_one_pay = mysqli_query($link,"SELECT * FROM current_pay WHERE month = '$results_month_bill' AND user_id = '$uid'");
                    ...
                    ?>
                                ...
                                if($data_one_pay=mysqli_fetch_assoc($records_one_pay)){
                                    ...
                                    <td><?php echo $data_one_pay['pay_name']; ?></td>
                                    <td style="text-align: center;"><a
                                            href="Download-Month.php?user_id=<?php echo urlencode($data_image_month['user_id']); ?>&month=<?php echo urlencode($results_month_bill); ?>"><?php $data_image_month['filename'];?><i
                                                class="fa fa-download"></i></a></td>
                                    <td style="text-align: center;">
                                        <button class="btn btn-dark" data-bs-toggle="modal"
                                            data-bs-target="#payment<?php echo $id; ?>">View&nbsp;<i
                ...
                <div class="card-body">
                    ...
                    ?>
                            <tr style="text-align: center;">
                                ...
                                <td style="text-align: center;">
                                    <button class="btn btn-dark" data-bs-toggle="modal"
                                        data-bs-target="#payment<?php echo $id; ?>">View&nbsp;<i class="fa fa-file-text"
                                                ...
                                                <div class="px-3 needs-validation">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label>Due Date</label>
                                                            <input type="date" class="form-control"
                                                                value="<?php echo $data_bill_month['due'] ?>" disabled>
                                                        </div>
                                                    </div>
        ...
        <div class="col-md-8">
            <div class="card border shadow-lg mb-4 p-2">
                <h2 class="text-center">Rejected Electricity Bill Management Form</h2>
                ...
                <div class="card border shadow-lg mb-3">
                    ...
                    <div class="card-body">
                        <div class="alert alert-danger alert-dismissible fade show" role="alert"
                            style="text-align: center;">
                            Send a reminder to upload the image of the meter before deadline&nbsp;<i
                        ...
                        <form class="px-3 needs-validation" method="POST"
                            ...
                            <div class="form-group"><br>
                                ...
                                <textarea type="text" style="height: 200px;" class="form-control"
                                    name="message">You have not uploaded the image of your electricity meter to get update about your payable bill. Please update it as soon as possible. Extra charges may apply if the image is not uploaded before the deadline! Discard this message if you have already uploaded the image.</textarea>
                            </div>
